        ...
        <section>
                    ...
                    <div className="hero_content">
                        ...
                        <div className="hero_btns">
                            ...
                            <button className="watch_btn">
                                <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path fill="#B197FC" d="M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80L0 432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z"/></svg>
                                </span>
                                <p>Watch Video</p>
                            </button>
            ...
            <div className="container exercise_container">
                <div className="exercise_top">
                    ...
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sapiente consequuntur molestias id earum maxime beatae doloribus animi laborum reprehenderit amet libero nihil eius explicabo, non distinctio optio, voluptas fuga provident?
                    </p>
                </div>
                ...
                <div className="exercise_wrapper">
                    <div className="exercise_item">
                        ...
                        <div className="exercise_content">
                            <h4>Healthy Life</h4>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ut repudiandae temporibus reiciendis aliquid consequuntur id, recusandae quisquam accusantium sequi iste accusamus libero nemo atque ex?
                            </p>
